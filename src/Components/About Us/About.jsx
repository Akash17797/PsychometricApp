        ...
        <div className="bg-white py-16">
            <div className="container mx-auto px-6 text-gray-600 md:px-12 xl:px-6">
                <div className="flex flex-col md:flex-row md:gap-6 lg:gap-12">
                    ...
                    <div className="flex flex-col justify-center md:w-1/2 lg:w-2/3 text-justify">
                        <div>
                            <h3 className="text-blue-600 text-2xl font-bold md:text-4xl mb-6 underline">About Us</h3>
                        ...
                        <div className="mt-8">
                            <h3 className="text-blue-600 text-2xl font-bold md:text-4xl mb-4 underline">Our Expertise</h3>
                        ...
                        <div className="mt-8">
                            <h3 className="text-blue-600 text-2xl font-bold md:text-4xl mb-4 underline">Our Passion</h3>
                            <p className="text-black">
                            ...
                            <ul className="list-disc list-inside text-blue-600 mt-4 space-y-2">
                                <li className='hover:text-red-500 hover:font-bold'>Discover your unique strengths, interests, and career-relevant skills</li>
                                <li className='hover:text-red-500 hover:font-bold'>Explore educational and vocational pathways that are the best fit for you</li>
                                <li className='hover:text-red-500 hover:font-bold'>Develop a clear, actionable plan to achieve your career aspirations</li>
                                <li className='hover:text-red-500 hover:font-bold'>Navigate the challenges and transitions of your professional development</li>
                            </ul>
