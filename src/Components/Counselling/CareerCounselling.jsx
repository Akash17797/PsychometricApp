    ...
    >
      <div className="flex w-full bg-opacity-15 rounded-2xl shadow-lg bg-white">
        ...
        <div className="flex-grow p-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-8 text-center underline">Career Counselling and its Benefits</h1>
          ...
          <div className="bg-blue-100 p-6 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">The Benefits of Career Counselling</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Self-Discovery</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Career Exploration</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Practical Guidance</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Informed Decision-Making</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Navigating Transitions</h3>
                <p className="text-gray-700">
