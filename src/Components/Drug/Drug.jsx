...
const Drug = () => {
  return (
    ...
    > <div className='flex bg-blue-200 bg-opacity-55'>
      ...
      <div className="max-w-5xl mx-auto bg-opacity-50 p-5 rounded-2xl bg-white">
        ...
        <div className="rounded-lg shadow-lg p-8 mb-8 animate-slideInUp">
          <p className="text-lg text-gray-900 font-semibold mb-4 hover:bg-blue-200 hover:bg-opacity-80 hover:p-2 hover:rounded-2xl hover:transform duration-1000">
          ...
          <p className="text-lg text-gray-900 font-semibold mb-4 animate-slideInLeft hover:bg-blue-200 hover:bg-opacity-80 hover:p-2 hover:rounded-2xl hover:transform duration-1000">
          ...
          <p className="text-lg text-gray-900 font-semibold mb-4 animate-slideInRight hover:bg-blue-200 hover:bg-opacity-80 hover:p-2 hover:rounded-2xl hover:transform duration-1000">
