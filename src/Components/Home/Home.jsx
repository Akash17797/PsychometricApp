        ...
        <div className="bg-gradient-to-br from-green-100 to-blue-900  w-full ">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                ...
                <div className=" absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full ">
                    <img className="w-96 rounded-full " src="src\images\HomeUp.jpg" alt="image1" />
                </div>
            </aside>
            ...
            <h1 className="text-center text-2xl sm:text-5xl py-10 font-medium">Build your dreams Now</h1>
        </div>
    );
}
