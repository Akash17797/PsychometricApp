        ...
        <div className='flex justify-center items-center min-h-screen bg-gradient-to-br from-green-300 to-blue-900 p-6'>
            <div className="bg-blue-300 max-w-5xl rounded-lg shadow-xl p-6">
                ...
                <section className="mb-8 ">
                    ...
                    <div className="bg-gray-200 rounded-lg p-4 mb-4 hover:scale-105">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center mb-6">
                        ...
                        <div className="md:w-2/3">
                            <ul className="list-disc list-inside text-gray-900">
                                ...
                                <li>13 years experience in providing Psychometric test (Personality, Interest, Aptitude, and Creativity test) based career guidance and counseling to the students of 9th to 12th classes</li>
                            </ul>
                        </div>
                    </div>
                </section>
