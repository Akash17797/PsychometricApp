...
//                 <h1 className="text-3xl font-bold mb-6 text-green-900">Psychometric Testing: A Comprehensive Approach to Personal and Professional Development</h1>
...
//                             <li className="hover:bg-green-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
//                                 <span className="text-green-900 font-bold">Discover their unique talents and abilities</span>
//                                 <p>Psychometric assessments can uncover the innate strengths and talents of Gen Z students, empowering them to pursue educational and career paths that align with their natural inclinations.</p>
//                             </li>
//                             <li className="hover:bg-green-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
//                                 <span className="text-green-900 font-bold">Explore diverse career options</span>
//                                 <p>By understanding their personality traits, cognitive skills, and problem-solving abilities, Gen Z students can explore a wider range of career possibilities, increasing their chances of finding fulfilling and rewarding work.</p>
//                             </li>
//                             <li className="hover:bg-green-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
//                                 <span className="text-green-900 font-bold">Develop essential soft skills</span>
//                                 <p>Psychometric testing often evaluates interpersonal skills, emotional intelligence, and adaptability – crucial attributes for success in the modern workplace. By identifying areas for improvement, Gen Z students can proactively develop these valuable soft skills.</p>
//                             </li>
//                             <li className="hover:bg-green-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
//                                 <span className="text-green-900 font-bold">Enhance academic and professional performance</span>
//                                 <p>Psychometric testing often evaluates interpersonal skills, emotional intelligence, and adaptability – crucial attributes for success in the modern workplace. By identifying areas for improvement, Gen Z students can proactively develop these valuable soft skills.</p>
//                             </li>
//                             <li className="hover:bg-green-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
//                                 <span className="text-green-900 font-bold">Navigate the changing job market</span>
//                                 <p>As the job market continues to evolve, psychometric testing can help Gen Z students navigate the complexities of the modern workforce, positioning them for success in an increasingly competitive and dynamic environment.</p>
//                             </li>
//                         </ul>
//                     </div>
//                     <p className="text-gray-700">
...
//                     </p>
//                 </div>
//                 <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mt-6 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
...
function Psychometric() {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-green-100 to-blue-900">
            <div className="bg-gradient-to-br from-green-100 to-blue-400 shadow-lg rounded-lg p-8 max-w-3xl w-full">
                <h1 className="text-3xl font-bold mb-6 text-green-900">Psychometric Testing: A Comprehensive Approach to Personal and Professional Development</h1>
                <div className="space-y-6">
                    <p className="text-gray-700">
                        In the ever-evolving landscape of personal and professional growth, psychometric testing has emerged as a powerful tool for individuals seeking to unlock their full potential. Psychometric tests are designed to assess a range of cognitive abilities, personality traits, and behavioral tendencies, providing a comprehensive understanding of an individual's strengths, weaknesses, and overall profile.
