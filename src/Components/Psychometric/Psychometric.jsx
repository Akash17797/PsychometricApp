    ...
    return (
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl w-full">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">Benefits of Psychometric Testing for Gen Z Students</h2>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li><b>Discover their unique talents and abilities</b>
              ...
              <li><b>Explore diverse career options</b>
              ...
              <li><b>Develop essential soft skills</b>
              ...
              <li><b>Enhance academic and professional performance</b>
                <p>Psychometric testing often evaluates interpersonal skills, emotional intelligence, and adaptability – crucial attributes for success in the modern workplace. By identifying areas for improvement, Gen Z students can proactively develop these valuable soft skills</p>
              </li>
              <li><b>Navigate the changing job market</b>
