...
const Footer = () => {
  return (
    <>
      ...
      <footer className="relative z-10 bg-none p-14 dark:bg-dark lg:pb-20 lg:pt-[120px]">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src="\src\Home\paras.jpg"
                    alt="logo"
                    className="max-w-full dark:hidden rounded-lg"
                  />
                  <img
                    src="\src\Home\paras.jpg"
                    alt="logo"
                ...
                <p className="mb-7 text-base text-white dark:text-dark-6">
                  Paras coaching and counselling
                ...
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <span>+91 94631 90913</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Resources">
              <NavLink link="/#" label="Test" />
              <NavLink link="/#" label="Test" />
              <NavLink link="/#" label="Test" />
              <NavLink link="/#" label="Test" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/#" label="About Paras" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-white dark:text-dark-6">
                  &copy; Paras Psychometric Testing Agency
                </p>
              </div>
            </div>
          </div>
